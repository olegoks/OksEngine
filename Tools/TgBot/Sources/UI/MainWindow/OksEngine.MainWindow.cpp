...
void GetWindowFramebufferResizeEvents::Update(
	ECS2::Entity::Id entity0id, const MainWindow* mainWindow0,
	MainWindowFramebufferResizeEvent* mainWindowFramebufferResizeEvent0,
	MainWindowFramebufferSize* mainWindowFramebufferSize0) {
...
void GetWindowWorkAreaResizeEvents::Update(
	ECS2::Entity::Id entity0id, const MainWindow* mainWindow0,
	MainWindowWorkAreaResizeEvent* mainWindowWorkAreaResizeEvent0,
	MainWindowWorkAreaSize* mainWindowWorkAreaSize0) {
...
void ClearWindowWorkAreaResizeEvents::Update(ECS2::Entity::Id entity0id, const MainWindow* mainWindow0,
	MainWindowWorkAreaResizeEvent* mainWindowWorkAreaResizeEvent0) {
