...
namespace Resource
{
	namespace Manager
	{
		...
		void ProcessLoadResourceRequest::Update(
			ECS2::Entity::Id entity0id,
			const Resource::Manager::Tag* manager__Tag0,
			const Resource::Manager::ResourcesRootPath* manager__ResourcesRootPath0,
			const Resource::Manager::Resources* manager__Resources0,

			ECS2::Entity::Id entity1id,
			const Resource::Manager::Request::Tag* request__Tag1,
			const Resource::Manager::Request::LoadResource* request__LoadResource1) {
