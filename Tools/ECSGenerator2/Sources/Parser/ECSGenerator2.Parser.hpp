				...
				std::sort(tables.begin(), tables.end(), [&](
					...
					ParsedTablePtr second) {
						...
						const auto getPriority = [](ParsedTable::Type type) {
							...
							case ParsedTable::Type::Enum:			return 1; // Высший приоритет
							case ParsedTable::Type::Struct:			return 2; // Высший приоритет
							case ParsedTable::Type::Component:		return 3;
							case ParsedTable::Type::Archetype:		return 4; // Высший приоритет
