...
namespace ECS2 {
	...
	//class System {
	//public:
	//	virtual void BeforeUpdate(ECS2::World* world) = 0; // Calls once at the begging even if there are noe entities
	...
	//	virtual void AfterUpdate(ECS2::World* world) = 0; // Calls once after end of updating even if there are no entities.
