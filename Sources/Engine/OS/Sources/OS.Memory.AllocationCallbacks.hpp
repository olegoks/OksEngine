...
namespace Memory {
	...
	using AllocationFunction = void*(*)(void* userData,
		Common::Size    size,
		Common::Size    alignment);/*std::function<void* (
		void* userData,
		Common::Size    size,
		Common::Size    alignment)>;*/

	using ReallocationFunction = void* (*)(void* userData,
		void* original,
		Common::Size    size,
		Common::Size    alignment);
	/*std::function<void* (
	...
	using FreeFunction = void(*)(void* userData, void* memory);/*std::function<void(
		void* userData,
		void* memory)>;*/

	static void* defaultAllocationFunction(void* userData,
		Common::Size    size,
		Common::Size    alignment){
