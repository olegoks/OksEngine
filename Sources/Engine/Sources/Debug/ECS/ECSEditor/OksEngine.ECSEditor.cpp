#pragma once
#include <Debug\ECS\ECSEditor\auto_OksEngine.ECSEditor.hpp>
...
namespace OksEngine
{
	...
	//MENU 
	void CreateECSEditorMenuItem::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
		const MainMenuBar* mainMenuBar0, const ECSMenu* eCSMenu0) {


		CreateComponent<ECSEditorMenuItem>(entity0id);
	...
	void ProcessECSEditorMenuItem::Update(
		...
		const ImGUI::State* imGUI__State0,
	...
	void GraphEditorBegin::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
	...
	void GetNodePosition::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
		const EditorContext* editorContext0, ECS2::Entity::Id entity1id,
		const CallGraphNode* callGraphNode1, const Name* name1, Position2D* position2D1) {
	...
	void RemoveLink::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
	...
	void GraphEditorEnd::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
		const EditorContext* editorContext0) {
	...
	void SetNodePosition::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
		...
		ax::NodeEditor::SetNodePosition(static_cast<int>(entity1id), { position2D1->x_, position2D1->y_ });
	...
	void DrawNodes::Update(
		ECS2::Entity::Id entity0id, 
		const CallGraphNode* callGraphNode0, 
		const Name* name0,
		const Position2D* position2D0,

		ECS2::Entity::Id entity1id,
		const ImGUI::State* imGUI__State1,
	...
	void DrawLink::Update(ECS2::Entity::Id entity0id, const Link* link0) {

		// Draw new link.
		ax::NodeEditor::Link(
			static_cast<int>(entity0id),
			static_cast<int>(link0->nodeFrom_),
			static_cast<int>(link0->nodeTo_));
	...
	void CreateNewNode::Update(
		...
		static bool showCreateSystemMenu = false;
		static ImVec2 newNodePostion{ 0, 0 };
		if (ImGui::BeginPopup("Create New Node"))
		{

			if (ImGui::MenuItem("System")) {
				showCreateSystemMenu = true;
				newNodePostion = ImGui::GetWindowPos();
			}
		...
		//}
			...
			static char systemName[256] = "TestName";
	...
	void CreateLink::Update(ECS2::Entity::Id entity0id, const ImGUI::State* imGUI__State0,
		const ECSEditorWindow* eCSEditorWindow0, const EditorContext* editorContext0) {
