...
namespace OksEngine {
	...
	void UpdateImGUIRenderData::Update(ECS::World* world, ECS::Entity::Id entityId, ECS::Entity::Id secondEntityId) {
	...
	Common::TypeId UpdateImGUIRenderData::GetTypeId() const noexcept {
		return Common::TypeInfo<UpdateImGUIRenderData>().GetId();
	}
}