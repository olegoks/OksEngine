...
layout(set = MATERIAL_SET, binding = MATERIAL_DIFFUSE_MAP_BINDING) uniform sampler2D textures[];     \
                                                                                                        \
...
#define MATERIAL_GET_DIFFUSE_MAP textures[nonuniformEXT(materialInfo.diffuseMapIndex)]
