	...
	namespace Render
	{
		namespace Debug
		{
			void CreateDebugger::Update() {
				...
				CreateComponent<FlatShade::VertexBuffer>(rendererId);
				CreateComponent<Lines::VertexBuffer>(rendererId);
			};
			...
			namespace FlatShade {
				...
				void UpdateDriverVertexBuffer::Update(
					...
					Render::Debug::FlatShade::VertexBuffer* vertexBuffer0, Render::Debug::FlatShade::DriverVertexBuffer* driverVertexBuffer0,
				...
				void ClearVertexBuffer::Update(ECS2::Entity::Id entity0id, const Render::Debug::Debugger* renderer0,
					Render::Debug::FlatShade::VertexBuffer* vertexBuffer0) {
				...
				void Draw::Update(ECS2::Entity::Id entity0id, RenderDriver* renderDriver0,
					...
					const Render::Debug::FlatShade::Pipeline* pipeline2, const Render::Debug::FlatShade::VertexBuffer* vertexBuffer2,
					const Render::Debug::FlatShade::DriverVertexBuffer* driverVertexBuffer2) {
			...
			namespace Lines {
				...
				void UpdateDriverVertexBuffer::Update(
					ECS2::Entity::Id entity0id, const Render::Debug::Debugger* renderer0,
					Render::Debug::Lines::VertexBuffer* vertexBuffer0, Render::Debug::Lines::DriverVertexBuffer* driverVertexBuffer0,
					ECS2::Entity::Id entity1id, RenderDriver* renderDriver1) {
				...
				void ClearVertexBuffer::Update(ECS2::Entity::Id entity0id, const Render::Debug::Debugger* renderer0,
					Render::Debug::Lines::VertexBuffer* vertexBuffer0) {
				...
				void Draw::Update(ECS2::Entity::Id entity0id, RenderDriver* renderDriver0,
					...
					const CameraTransformResource* cameraTransformResource1, ECS2::Entity::Id entity2id,
					const Render::Debug::Debugger* renderer2, const Render::Debug::Enable* enable2,
					const Render::Debug::Lines::Pipeline* pipeline2, const Render::Debug::Lines::VertexBuffer* vertexBuffer2,
					const Render::Debug::Lines::DriverVertexBuffer* driverVertexBuffer2) {
