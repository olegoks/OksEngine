		...
		namespace Material {
			namespace NormalMap
			{
				void CreateResource::Update(
					...
					const Info* textureInfo1,
					const Data* textureData1) {
			...
			#undef max
					...
					CreateComponent<Render::Material::NormalMap::Resource>(textureEntityId, textureId, textureRSId);


				};

			}
			namespace AmbientMap
			{
				void CreateResource::Update(
					ECS2::Entity::Id entity0id,
					RenderDriver* renderDriver0,
			...
			#undef max
					...
					CreateComponent<Resource>(textureEntityId, textureId, textureRSId);


				};

			}
			namespace DiffuseMap {
				void CreateResource::Update(
					ECS2::Entity::Id entity0id,
					RenderDriver* renderDriver0,

					ECS2::Entity::Id entity1id,
					const Render::Material::DiffuseMap::Info* textureInfo1,
					const Render::Material::DiffuseMap::Data* textureData1) {
			...
			#undef max
					...
					CreateComponent<Render::Material::DiffuseMap::Resource>(textureEntityId, textureId, textureRSId);
