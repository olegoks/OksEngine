...
namespace OksEngine
{
	namespace Render
	{
		...
		#undef max
				...
				CreateComponent<TextureResource>(textureEntityId, textureId, textureRSId);
		...
		namespace DiffuseMap {
			void CreateTextureResource::Update(
				...
				ECS2::Entity::Id entity1id,
				const Render::DiffuseMap::TextureInfo* textureInfo1,
				const Render::DiffuseMap::TextureData* textureData1) {
		...
		#undef max
				...
				CreateComponent<Render::DiffuseMap::TextureResource>(textureEntityId, textureId, textureRSId);
